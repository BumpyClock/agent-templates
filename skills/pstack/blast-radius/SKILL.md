...
Use `how` for runtime behavior. Inspect relevant history for rationale. Use this skill to assess effects on dependent systems.
...
1. Read the change. The diff, the symbols it adds, changes, and deletes, and what it now does differently, including the part the diff doesn't spell out. Inspect the relevant PR and commits.
