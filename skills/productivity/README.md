...
- **[canvas](./canvas/SKILL.md)** — Create portable, self-contained HTML artifacts for standalone analyses and structured findings, usable by primary agents and subagents.
