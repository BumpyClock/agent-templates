...
Load this when reviewing responsive behaviour, breakpoints, or state coverage on a data-driven page. `guide.md` already covers theming, control choice, and XAML landmines — don't duplicate.
