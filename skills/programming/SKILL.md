...
2. TEST FOR REGRESSION VALUE. Add or change a test when behavior, a bug boundary, or an important invariant would otherwise be unprotected. Do not add tests merely because code changed.
