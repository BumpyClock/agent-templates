...
- **[implement](./implement/SKILL.md)** — Implement a spec or tickets with risk-based checks, then use `/code-review` before commit.
...
- **[tdd](./tdd/SKILL.md)** — Use the test-first workflow when the user or repository explicitly requires TDD.
