...
5. Verify the inherited claims against the original goal on the real artifact (the [principle-prove-it-works](../references/principle-prove-it-works.md) reference). A passing prior self-report is not the proof.
